        ...
        return [
            {
                ...
                Columns: [
                    ...
                    { InternalName: "ImageUrl", Type: "URL", Description: "URL of the page thumbnail image" },
                    { InternalName: "ImageName", Type: "Text", Description: "Name of the page thumbnail image file" },
