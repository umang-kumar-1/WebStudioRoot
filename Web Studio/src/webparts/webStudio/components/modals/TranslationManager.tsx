                                ...
                                <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td className="py-4 px-6">
                                        <div className="flex gap-2">
                                            {item.translations.de && <span className="inline-flex items-center px-1.5 py-0.5 border border-gray-200 bg-white text-[10px] font-bold text-gray-700 uppercase"><span className="mr-1">🇩🇪</span> DE</span>}
                                            {item.translations.fr && <span className="inline-flex items-center px-1.5 py-0.5 border border-gray-200 bg-white text-[10px] font-bold text-gray-700 uppercase"><span className="mr-1">🇫🇷</span> FR</span>}
                                            {item.translations.es && <span className="inline-flex items-center px-1.5 py-0.5 border border-gray-200 bg-white text-[10px] font-bold text-gray-700 uppercase"><span className="mr-1">🇪🇸</span> ES</span>}
