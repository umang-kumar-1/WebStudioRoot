...
export const FooterManager = ({ onClose }: { onClose: () => void }) => {
    ...
    const getContactIcon = (type: string) => {
        ...
        switch (type) {
            ...
            default: return <HelpCircle className="w-5 h-5" style={style} />;
        }
    };
    ...
    const renderPropertiesPanel = () => {
        ...
        if (selectedItem.type === 'CONTACT') {
            return (
                <div className="p-6 space-y-6">
                    <div className="flex items-center gap-2 mb-4 pb-4 border-b border-gray-100">
                        <div className="p-2 bg-blue-100 rounded-sm text-[#254784]"><MapPin className="w-4 h-4" /></div>
                        <div>
                        ...
                        <div className="flex-1 overflow-y-auto p-8 space-y-8">
                            ...
                            <div className="bg-white border border-gray-200 shadow-sm rounded-sm overflow-hidden">
                                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors" onClick={() => setActiveSection(activeSection === 'CONTACT' ? null : 'CONTACT')}>
                                    <div className="flex items-center gap-3">
                                        <div className="p-1.5 bg-blue-100 rounded-sm text-[#254784]"><MapPin className="w-4 h-4" /></div>
                                        <div>
                                            <h4 className="text-sm font-bold text-gray-800">{getTranslation('SECTION_CONTACT_INFO', currentLanguage)}</h4>
                                                ...
                                                <div className="w-full py-12 px-8">
                                                        ...
                                                        <div className="space-y-4 text-left">
                                                            <div className="space-y-1">
                                                                {(localConfig.brandItems && localConfig.brandItems.length > 0) ? (
                                                                    ...
                                                                    <div className="text-left text-[#254784]">
                                                                        <h4 className="font-bold mb-2" style={{ fontSize: localConfig.fontSettings.headingSize }}>{siteConfig.name}</h4>
                                                                        <p className="opacity-80 leading-relaxed" style={{ fontSize: localConfig.fontSettings.subHeadingSize }}>
                                                            ...
                                                            <div className="mt-2 text-left">
                                                                <button
                                                                    ...
                                                                    className="w-8 h-8 rounded-full border border-[#254784] bg-white flex items-center justify-center text-[#254784] hover:bg-blue-50 transition-colors shadow-sm"
                                                                >
                                                            ...
                                                            <div className="space-y-3">
                                                                {(localConfig.contactItems && localConfig.contactItems.length > 0) ? (
                                                                    localConfig.contactItems.map(item => (
                                                                        <div key={item.id} className="flex items-center justify-end gap-3" style={{ color: '#254784', fontSize: localConfig.fontSettings.subHeadingSize }}>
                                                                    ...
                                                                    <div className="space-y-3">
                                                                        {localConfig.contactInfo.email && (
                                                                            <div className="flex items-center justify-end gap-3 text-[#254784]" style={{ fontSize: localConfig.fontSettings.subHeadingSize }}>
                                                    ...
                                                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 opacity-70 text-sm">
                                                        <div className="flex flex-col items-start gap-2">
                                                            <div className="flex items-center gap-1 text-[#254784]">
                                                                {(localConfig?.bottomLinks && localConfig.bottomLinks.length > 0) ? (
                                                                    localConfig.bottomLinks.map((link, idx) => (
                                                                        <React.Fragment key={link.id}>
                                                                            <span className="hover:text-[#254784] cursor-pointer transition-colors px-1">{link.label}</span>
                                                        ...
                                                        <div className="flex flex-col items-end gap-2 text-right">
                                                            <div className="text-[#254784] font-medium opacity-80">{getLocalizedText(localConfig.copyright, currentLanguage)}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            )}
                                    ...
                                    <div className="w-full">
                                                        ...
                                                        <div className="space-y-2">
                                                            {col.links.map((link, lIdx) => (
                                                                <div key={link.id} className="flex gap-2 text-sm">
                                                                    <input
                                                                        value={getLocalizedText(link.label, currentLanguage)}
                                                                        onChange={(e) => {
                                                                            const newCols = [...localConfig.columns];
                                        ...
                                        {localConfig.template === 'Corporate' && (
                                            <div className="w-full space-y-8">
                                                ...
                                                <div>
                                                    <h5 className="text-[#254784] font-bold mb-4 flex items-center gap-1">
                                                    ...
                                                    <div className="space-y-4 bg-gray-50 p-4 rounded-lg border border-gray-100">
                                                            ...
                                                            <div key={item.id} className="bg-white border border-gray-200 rounded p-4 flex gap-4 group relative">
                                                                <div className="flex-1 space-y-3">
                                                                    <input
                                                                        ...
                                                                        className="w-full border-b border-gray-100 hover:border-gray-300 focus:border-[#254784] py-1 text-sm outline-none transition-colors"
                                                                        placeholder="Label"
                                                                    />
                                                                    <input
                                                                        type="text"
                                                        ...
                                                        <button
                                                            ...
                                                            className="w-full py-3 border-2 border-dashed border-[#254784]/30 rounded-lg text-[#254784] font-bold text-sm bg-white hover:bg-slate-50 transition-colors flex items-center justify-center gap-2"
                                                        >
                                                    ...
                                                    <div className="space-y-4 bg-gray-50 p-4 rounded-lg border border-gray-100">
                                                        {(localConfig.socialItems || []).map((item, idx) => (
                                                            <div key={item.id} className="bg-white border border-gray-200 rounded p-4 flex gap-4">
                                                                <div className="w-10 h-10 bg-[#254784] rounded-full flex items-center justify-center text-white mt-1 shadow-sm">
                                                                ...
                                                                <div className="flex-1 space-y-3">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        className="w-full border-b border-gray-100 hover:border-gray-300 focus:border-[#254784] py-1 text-sm outline-none transition-colors bg-transparent appearance-none"
                                                                    >
                                                ...
                                                <div>
                                                    ...
                                                    <div className="space-y-4 bg-gray-50 p-4 rounded-lg border border-gray-100">
                                                        {(localConfig.contactItems || []).map((item, idx) => (
                                                            <div key={item.id} className="bg-white border border-gray-200 rounded p-4 flex gap-4">
                                                                <div className="w-10 h-10 bg-[#254784]/10 rounded-full flex items-center justify-center text-[#254784] mt-1">
                                                            ...
                                                            <div key={item.id} className="bg-white border border-gray-200 rounded p-4 flex gap-4">
                                                                <div className="flex-1 grid grid-cols-2 gap-4">
                                                                    <input
                                                                        ...
                                                                        className="w-full border p-2 rounded text-sm outline-none focus:border-[#254784]"
                                                                        placeholder="Label"
                                                                    />
                                                                    <input
                                                                        type="text"
