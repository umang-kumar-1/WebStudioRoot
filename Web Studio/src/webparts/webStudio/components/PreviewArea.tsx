...
import {
    Pencil, Type as TypeIcon, CheckCircle, Check, Plus,
...
export const PreviewArea: React.FC = () => {
    const { pages, currentPageId, setCurrentPage, viewMode, siteConfig, currentLanguage, translationItems, openModal } = useStore();
